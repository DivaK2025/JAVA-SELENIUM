...
public static void main(String[]args)throws InterruptedException{
	...
	driver.findElement(By.xpath("/html/body/div[4]/div/div/div[2]/div/ul/li[5]/a")).click();
	Thread.sleep(1000);
	
	driver.findElement(By.xpath("/html/body/div[4]/div/div/div[2]/div/ul/li[6]/a")).click();
	Thread.sleep(1000);
	
	driver.findElement(By.xpath("/html/body/div[4]/div/div/div[2]/div/ul/li[7]/a")).click();
	Thread.sleep(1000);
